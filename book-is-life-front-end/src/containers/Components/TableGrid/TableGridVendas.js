...
export function TableGridVendas(props) {
    ...
    const columns = [
        ...
        {field: "dtVenda",headerName: "Data de Venda",width: 170},
        {field: "nomeCliente", headerName: "Cliente",width: 230},
...
export default connect(null, mapDispatchToProps)(TableGridVendas)
